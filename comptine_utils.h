...
/*retourne 1 si le nom de fichier donné en paramètre n'existe pas 
*encore dans le repertoire des comptines
*/
int is_folder_exist(const char *dir_name, const char *nom_fichier);

/* Libère le catalogue c et crée un nouveau catalogue dans le repertoire
*  dir_name et c pointe vers cette nouvelle variable*/
